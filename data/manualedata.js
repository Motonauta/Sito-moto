  ...
  const GUIDE = [
    {
      ...
      data: "2026-08-12",
      blocchi: [
        { tipo: "paragrafo", testo: "L'estate, con il caldo sempre più esagerato di questi ultimi anni, sta diventando un banco di prova vero per chi viaggia in moto. Se ci vogliamo bene dobbiamo comunque indossare vere e proprie armature — dress for the slide, not for the ride — quindi il problema non è mai \"quanto vestirsi\", ma come sopravvivere al caldo restando protetti." },
        { tipo: "paragrafo", testo: "In questi anni di viaggi insieme alla Capracrew, il nostro trio di viaggiatori, ho imparato qualche trucco sul campo. Eccoli qui, uno per uno." },
        {
          tipo: "consiglio", numero: 1, titolo: "Viaggia di notte nei giorni più intensi",
          testo: "Per le giornate in cui bisogna macinare più chilometri, noi preferiamo far cadere gran parte del viaggio nelle ore notturne. Se dobbiamo fare 600 km, partiamo direttamente dopo cena; se sono 900, si parte verso le 18 così arriviamo a destinazione già in mattinata, con il grosso della strada fatto al fresco."
        },
        {
          tipo: "consiglio", numero: 2, titolo: "Una borsa frigo morbida in valigia",
          testo: "Da quando guido questa muccona rossa (la mia S1000XR) non ho più problemi di spazio in valigia, e quando viaggio da solo trovo sempre posto per una borsa frigo morbida — economica, efficiente e compatta (non mi paga nessuno, il link è qui sotto solo perché la uso davvero). Con 3 ghiaccetti dentro il contenuto resta freddo per decine di ore, e ci entrano comodamente 6 bottiglie da mezzo litro d'acqua: in 3 significa un litro a testa di acqua fresca. Ogni tot soste sostituiamo 3 bottiglie con altrettante appena prese da un supermercato o un negozio lungo la strada, che restano fresche nella borsa fino alla sosta successiva.",
        ...
        },
        {
          ...
          testo: "Non è una novità per nessuno, soprattutto per chi viaggia verso il mare — ma io la tengo sempre pronta nella borsa da serbatoio, a portata di mano per le parti che restano scoperte anche con tutte le protezioni addosso: il collo, i polsi, soprattutto quando capita di indossare una giacca un po' più corta o dei guanti molto estivi. Io uso sempre una protezione 50+."
        },
        {
          tipo: "consiglio", numero: 4, titolo: "Il trucco della maglietta bagnata",
          testo: "Quando il clima è davvero esagerato — come qualche settimana fa a Stoccarda con la Crew, dove in autobahn la moto segnava 41 gradi — quello che ci ha salvati è stato bagnare la maglietta sotto la giacca a ogni sosta. Sembra banale, ma con una giacca traspirante estiva e la maglietta ben bagnata sotto, l'aria che passa diventa magicamente fresca. L'unico difetto è che con quelle temperature il trucco dura al massimo mezz'ora prima che si asciughi del tutto, ma ogni sosta mi rimetteva letteralmente al mondo. (Per i viaggi porto sempre canotte o magliette economiche sotto la giacca: se si allargano un po' per il peso dell'acqua non me ne importa nulla.)"
        },
        {
          tipo: "consiglio", numero: 5, titolo: "Gambe lontane dal motore",
          testo: "Può sembrare banale, ma chi ha una moto da viaggio — soprattutto di cilindrata alta — sa bene che con le temperature esagerate, oltre al vento caldo, al sole che picchia e all'aria calda che sale dall'asfalto, c'è anche la tortura di un motore rovente che soffia altro caldo addosso. Io cerco sempre di tenere i piedi appoggiati sui telai paramotore, così le gambe restano aperte e l'aria passa anche in mezzo. Questo vale su autostrada o extraurbane lunghe con pochi incroci: il consiglio è restare comunque sempre pronti a rimettere i piedi al loro posto (cambio e freno posteriore a portata), ma nei tratti lunghi, con buona visuale e pochi pericoli, è un ottimo modo per non autotorturarsi con il calore della propria muccona."
        },
        {
          tipo: "consiglio", numero: 6, titolo: "Un mini ventilatore nella borsa da serbatoio",
          testo: "Sembra banale ma nella borsa da serbatoio ho sempre anche un mini ventilatore portatile — di quelli che si vedono spesso in mano ai turisti in città. È stata una scoperta utilissima soprattutto ai semafori temporanei dei cantieri, quelli che si trovano spesso sui passi di montagna: quando tocca stare fermi sotto al sole anche più di un minuto e mezzo, a moto spenta lo incastro sulla visiera e mi tiene il viso fresco anche dentro al casco integrale."
        },
        {
        ...
        { tipo: "paragrafo", testo: "I consigli per ora finiscono qui, ma se al prossimo viaggio scopro qualche altro trucco utile aggiornerò l'articolo. Se anche tu hai qualche consiglio pratico da condividere, scrivimi in privato su Instagram: lo aggiungo qui, con il tuo tag accanto." }
      ]
    }
  ];
